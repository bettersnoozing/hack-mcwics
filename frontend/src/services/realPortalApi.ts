...
export function createRealPortalApi(): PortalApi {
  ...
  return {
    ...
    bulkUpdateApplicationStatus: () => _stub('bulkUpdateApplicationStatus'),
    getReviewThread: () => _stub('getReviewThread'),
    addTopLevelReview: () => _stub('addTopLevelReview'),
    replyToReview: () => _stub('replyToReview'),
    getInternalNotes: () => _stub('getInternalNotes'),
    addInternalNote: () => _stub('addInternalNote'),
    getActivityTimeline: () => _stub('getActivityTimeline'),
    listInterviewSlots: () => _stub('listInterviewSlots'),
    createInterviewSlot: () => _stub('createInterviewSlot'),
    deleteInterviewSlot: () => _stub('deleteInterviewSlot'),
